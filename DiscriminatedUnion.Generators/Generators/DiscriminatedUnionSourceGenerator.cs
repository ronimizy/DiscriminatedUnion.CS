...
using DiscriminatedUnion.Generators.Generators.Pipeline;
using DiscriminatedUnion.Generators.Generators.Pipeline.Models;
using DiscriminatedUnion.Generators.Generators.Pipeline.WrappedTypeBuilding;
...
using DiscriminatedUnion.Generators.Generators.SourceComponents.Visitors;
using DiscriminatedUnion.Generators.Utility;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using Microsoft.Extensions.DependencyInjection;

namespace DiscriminatedUnion.Generators.Generators
{
    [Generator]
    public class DiscriminatedUnionSourceGenerator : ISourceGenerator
    {
            ...
            INamedTypeSymbol unionInterface)
        {
            ...
            var usingSystemVisitor = new AddUsingVisitor("System", "DiscriminatedUnion");
